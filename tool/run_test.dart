...
void main(List<String> args) async {
    var parser = ArgParser()
        ...
        ..addFlag('trace-solver-enqueing', help: 'Trace the solver enqueuing solutions.')
        ..addFlag('trace-solver-dequeing', help: 'Trace the solver dequeuing solutions.')
...
Future<void> _runTest(String path, int line) async {
    ...
    var isCorrect = actual.textWithSelectionMarkers == output.code.textWithSelectionMarkers;

    print(
        [
            if (isCorrect) 'Correct' else 'Incorrect',
            'formatting for $path:$line',
            if (formatTest.input.description.isNotEmpty) '"${formatTest.input.description}"',
        ].join(' '),
    );
    print('');
    print('Input:');
