...
void main() {
    group('findLanguageVersion()', () {
        ...
        test('multiple packages in directory', () async {
            await d.dir('parent', [_makePackage('foo', '3.4'), _makePackage('bar', '3.5')]).create();
...
Future<void> _expectTrailingCommas(TrailingCommas? trailingCommas, {String file = 'dir/main.dart'}) async {
    var cache = ConfigCache();
...
d.DirectoryDescriptor _makePackage(String packageName, String version, [List<d.Descriptor>? files]) {
