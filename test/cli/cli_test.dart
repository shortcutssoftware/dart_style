...
void main() {
    ...
    group('--enable-experiment', () {
        test('passes experiment flags to parser', () async {
            ...
            expect(await process.stderr.next, 'Please report at: github.com/dart-lang/dart_style/issues');
            expect(await process.stderr.next, 'The formatter produced unexpected output. Input was:');
