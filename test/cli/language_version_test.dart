...
''';
    ...
    group('package config', () {
        test('no package search if language version is specified', () async {
            ...
            await d.dir('foo', [
                d.dir('.dart_tool', [d.file('package_config.json', 'this no good json is bad json')]),
        ...
        test('default to language version of surrounding package', () async {
            ...
            expect(await process.stderr.next, 'Could not format because the source could not be parsed:');
...
'''),
    ...
    group('stdin', () {
        ...
        test('no package search if language version is specified', () async {
            ...
            var process = await runFormatter(['--language-version=2.19', '--stdin-name=foo/main.dart']);
