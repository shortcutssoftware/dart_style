...
void _runTests({required bool isTall}) {
    DartFormatter makeFormatter({Version? languageVersion, int? indent, String? lineEnding}) {
        ...
        return DartFormatter(languageVersion: languageVersion, indent: indent, lineEnding: lineEnding);
    }
...
''';
    ...
    test('FormatterException.message() does not throw', () {
        ...
        expect(
            ...
            throwsA(
                isA<FormatterException>().having((e) => e.message(), 'message', contains('Could not format')),
            ),
        );
    });
    ...
    group('line endings', () {
        test('uses given line ending', () {
            ...
            // ending.
            var lineEnding = '\t';
            expect(makeFormatter(lineEnding: lineEnding).format('var i = 1;'), equals('var i = 1;\t'));
        });
