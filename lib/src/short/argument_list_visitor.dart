...
final class ArgumentListVisitor {
    ...
    bool get _isSingle => _allArguments.length == 1 && _allArguments.single is! NamedArgument;
...
final class ArgumentSublist {
    ...
    factory ArgumentSublist(List<Argument> allArguments, List<Argument> arguments) {
    ...
    void _visitArguments(SourceVisitor visitor, List<Argument> arguments, ArgumentRule rule) {
    ...
    void _visitArgument(SourceVisitor visitor, ArgumentRule rule, Argument argument) {
