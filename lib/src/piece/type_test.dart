...
final class TypeTestPiece extends Piece {
    ...
    TypeTestPiece(this._expression, this._operator, this._type, {bool canBlockSplit = false})
        : _canBlockSplit = canBlockSplit;

    @override
    List<State> get additionalStates => [if (_canBlockSplit) _blockSplitExpression, State.split];
