...
extension AstNodeExtensions on AstNode {
    ...
    BlockFormat get blockFormatType => switch (this) {
        ...
        NamedArgument(:var argumentExpression) => argumentExpression.blockFormatType,
...
extension ExpressionExtensions on Expression {
    ...
    bool get hasSingleElement {
        ...
        return switch (expression) {
            ...
            FunctionExpressionInvocation(:var argumentList) => argumentList.arguments.length == 1,
            ListLiteral(:var elements) || SetOrMapLiteral(:var elements) => elements.length == 1,
...
extension AdjacentStringsExtensions on AdjacentStrings {
    ...
    bool get indentStrings {
        return switch (parent) {
            ...
            Assertion(:var condition, :var message) => _hasOtherStringArgument([condition, ?message]),
    ...
    bool _hasOtherStringArgument(Iterable<Argument> arguments) =>
