...
final class DartFormatter {
    ...
    static final latestShortStyleLanguageVersion = DartVersionHistory.latestShortStyle;
...
class _FormatterDiagnosticCode extends DiagnosticCode {
    _FormatterDiagnosticCode({required super.name, required super.problemMessage, required super.uniqueName});
...
class _StringSource extends Source {
    ...
    bool operator ==(Object object) {
        return object is _StringSource && object._contents == _contents && object.fullName == fullName;
    }
