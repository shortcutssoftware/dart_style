...
final class FormattingStyle {
    ...
    bool get preserveTrailingCommaAfterForUpdaters => _formatter.trailingCommas == TrailingCommas.preserve;

    /// Whether a trailing comma should be preserved after enum values.
    bool get preserveTrailingCommaAfterEnumValues =>
        _formatter.trailingCommas == TrailingCommas.preserve && _languageVersion >= _version3Dot10;
    ...
    bool get avoidSplittingSingleElementCallChainTargets => _languageVersion >= _version3Dot13;
    ...
    bool get blankLineAroundMixinAndExtensionTypes => _languageVersion >= _version3Dot13;
