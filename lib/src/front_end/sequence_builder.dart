...
final class SequenceBuilder {
    ...
    void visit(AstNode node, {Indent? indent, bool blankBefore = false, bool allowBlankAfter = true}) {
        var wroteBlank = addCommentsBefore(node.firstNonCommentToken, indent: indent);
